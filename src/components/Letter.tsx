...
export const Letter = ({letter, onClick}:{letter:L, onClick: () => void}) => {
  ...
  const bg = !letter.feedback? "bg-gray-500" : letter.feedback === "match"? " bg-green-600 border-green-600" : letter.feedback === "misplaced"? " bg-yellow-500 border-yellow-500" : " bg-gray-600"
  return (
